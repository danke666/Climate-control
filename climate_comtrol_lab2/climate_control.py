...
def climate_control(day, t):
    """
    Функция климат-контроля: проверяет температуру, корректирует, если нужно, и возвращает итоговую температуру.
    Аргументы:
        day (str): Название дня недели.
        t (int): Исходная температура в °С.
    Возвращает:
        tuple: (corrected_t, action) - итоговая температура и строка с описанием действия.
    """
